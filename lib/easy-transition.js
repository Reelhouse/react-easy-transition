...
var EasyTransition = function (_Component) {
    ...
    function EasyTransition() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = EasyTransition.__proto__ || Object.getPrototypeOf(EasyTransition)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            visible: true
    ...
    _createClass(EasyTransition, [{
        ...
        value: function render() {
            return _react2['default'].createElement(
                ...
                { transitionName: 'fade', className: this.props.className, component: this.props.component || "div" },
...
var TransitionChild = function (_Component2) {
    ...
    function TransitionChild() {
        ...
        return _possibleConstructorReturn(this, (TransitionChild.__proto__ || Object.getPrototypeOf(TransitionChild)).apply(this, arguments));
    }
    ...
    _createClass(TransitionChild, [{
        ...
        value: function componentFadeIn(callback) {
            ...
            _extends(this.page.style, this.props.initialStyle);
            ...
            _extends(this.page.style, this.props.finalStyle);
        ...
        value: function componentWillLeave(callback) {
            ...
            _extends(this.page.style, leaveStyle);
            var transitionsRemaining = this.props.transition.split(',').length;
            this.page.addEventListener("transitionend", function (event) {
                transitionsRemaining--;
                if (transitionsRemaining) return;
